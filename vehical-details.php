...
<head>
    ...
    <link rel="stylesheet" href="assets/css/detailsStyle.css" type="text/css">
        ...
        <div class="row">
            ...
            <aside class="col-md-3">
                ...
                <div class="sidebar_widget">
                    ...
                    <form method="post" action="car-booking.php">
                        ...
                        <div class="form-group">
                            <p name="choose">Da li vam je potreban vozač?</p>
                        ...
                        <div class="form-group">
                            <p name="choose1">Dostava na željenu lokaciju?</p>
                            <input type="checkbox" id="locationInput" name="location" value="yes">
                            <label for="locationInput">Yes</label><br>
                            <input type="text" name="address" class="addressInput" placeholder="Unesite adresu za dostavu" />
                        </div>
                </div>
